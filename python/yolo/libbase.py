...
class LibBase:
    ...
    def __init__(self, model_path: str, platform=ACC_PLAT_AUTO):
        self.suffix = None
        self.platformMode = platform
    ...
    def _set(self, model_path: str):
        ...
        if self.platformMode == ACC_PLAT_AUTO:
        ...
        libPath = osp.join(
            ...
            f"libyoloInfer{suffix_map[self.suffix] if self.platformMode == ACC_PLAT_AUTO else __platformNames[self.platformMode]}.so"
        )
