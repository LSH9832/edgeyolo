#ifndef DETECT_PROCESS_H
#define DETECT_PROCESS_H
...
namespace detect {
    ...
    static cv::Mat static_resize(cv::Mat& img, cv::Size input_size) {
    ...
    static resizeInfo resizeAndPad(cv::Mat &src_img, cv::Size _size, bool center=false, bool show=false)
    {
