...
#define LDEBUG logger.debug(LOG_LOC)
#define LINFO logger.info(LOG_LOC)
#define LSUCCESS logger.success(LOG_LOC)
#define LWARN logger.warning(LOG_LOC)
#define LERROR logger.error(LOG_LOC)
